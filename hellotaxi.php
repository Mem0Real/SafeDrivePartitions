...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light w-100">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#hellotaxi.php" style="color: white; font-size: 35px; letter-spacing: 5px;"><img class="rounded rounded-pill" src="./images/hellotaxi.jpg" width="70px" height="70px" style="margin-left: -5px;"></a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" style="background-color: rgb(198, 139, 53);">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                      <ul class="navbar-nav">
                        ...
                        <div class="nav-item">
                            <div class="dropdown">
                                <i id="viewNewBtn" class="far fa-bell btn rounded-circle dropbtn mb-2" style="font-size: 20px; background-color: rgb(198, 139, 53); color: black;"></i>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
                    ...
                    <div class="slider-text">
						<h1>Welcome Hello-Taxi Rep.</h1>
						<h2>What would you like to do?</h2>
						<p>	
                            <a id="viewBtn" onclick="viewOrders();" style="background-color: rgb(198, 139, 53)">View Orders </a>
                            <a id="changeBtn" data-bs-toggle="modal" data-bs-target="#changeModal" style="background-color: rgb(198, 139, 53)">Change Password </a>
                            <a id="historyBtn" onclick="showHistory();" style="background-color: rgb(198, 139, 53)">Show History </a>
						</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="historyModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(0px);">
                <div class="modal-header mx-auto" style="border-radius: 15px; background: transparent; border-bottom: none; border-left: 3px solid rgb(198, 139, 53); border-right: 3px solid rgb(198, 139, 53);">
                ...
                <div class="move">
                    <div class="modal-body bg-dark responsive pt-5" style="border-top: 0.5px inset rgb(198, 139, 53); border-bottom: 1px inset rgb(198, 139, 53);">
    ...
    <div class="modal fade" id="changeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(2px); border-bottom: 0.5px solid rgb(198, 139, 53);">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid rgb(198, 139, 53); border-right: 3px solid rgb(198, 139, 53); border-bottom: none; border-radius: 15px;">
                        ...
                        <div class="form-group col-6 mx-auto">
                            ...
                            <div class="input-group">
                                <div>
                                    ...
                                    <i class="far fa-eye-slash" id="togglePassword1" style="margin-right: 1em; color: black; float: right; margin-top: -26.5px; cursor: pointer;"></i>
                                </div>
                            </div>
                        </div> 
                        <br> <br>
                        ...
                        <div class="form-group col-6 mx-auto">
                            ...
                            <div class="input-group">
                                <div>
                                    ...
                                    <i class="far fa-eye-slash" id="togglePassword2" style="margin-right: 1em; color: black; float: right; margin-top: -26.5px; cursor: pointer;"></i>
                                </div>
                            </div>
                        </div>
                        <br>
