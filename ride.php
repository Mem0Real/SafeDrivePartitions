...
<body> 
    ...
    <!-- NavBar -->
	<div class="nav-area fixed-top" style="background-color: #000;">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light w-100">
                <div class="container-fluid">
                  <img class="img-fluid float-start" src="./images/ridelogo.png" style="max-width: 15%; max-height: 5%;">
			    ...
			    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			      <ul class="navbar-nav">
                    ...
                    <div class="nav-item">
                        <div class="dropdown">
                            <i id="viewNewBtn" class="far fa-bell btn rounded-circle dropbtn mb-2" style="font-size: 20px; background-color: rgb(251, 206, 15); color: black;"></i>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
                    ...
                    <div class="slider-text">
						<h1>Welcome Ride Rep.</h1>
						<h2>What would you like to do?</h2>
						<p>	
                            <a id="viewBtn" onclick="viewOrders();" style="background-color: rgb(251, 206, 15); color: black;">View Orders </a>
                            <a id="changeBtn" data-bs-toggle="modal" data-bs-target="#changeModal" style="background-color: rgb(251, 206, 15); color: black;">Change Password </a>
                            <a id="historyBtn" onclick="showHistory();" style="background-color: rgb(251, 206, 15); color: black;">Show History </a>
						</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="historyModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(3px);">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid #000; border-right: 3px solid #000; border-bottom: none; border-radius: 15px;">
                ...
                <div class="move">
                    <div class="modal-body bg-dark responsive pt-5" style="border-top: 1px inset #000; border-bottom: 5px solid #000;">
    ...
    <div class="modal fade" id="viewModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(3px);">
                ...
                <div class="move">
                    <div class="modal-body bg-dark responsive pt-5" style="border-top: 0.5px inset #000; border-bottom: 5px solid #000;">
                        <p id="tblplace"></p>
                    </div>
                </div>       
            </div>
    ...
    <div class="modal fade" id="changeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content pt-3" style="background: transparent; backdrop-filter: blur(3px); border-bottom: 4px solid  rgb(251, 206, 15);">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid  rgb(251, 206, 15); border-right: 3px solid  rgb(251, 206, 15); border-bottom: none; border-radius: 15px;">
