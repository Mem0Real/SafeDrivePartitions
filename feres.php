...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light w-100">
			  <div class="container-fluid">
                <a class="navbar-brand fer" href="feres.php" style="color: white; font-size: 35px; letter-spacing: 5px"><img style="border-radius: 16em;" src="images/fereslogo.png" alt="| Feres"></a>
			    ...
			    <div class="nav-container collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			      <ul class="navbar-nav">
                    ...
                    <div class="nav-item">
                        <div class="dropdown">
                            <i id="viewNewBtn" class="far fa-bell btn rounded-circle dropbtn mb-2" style="font-size: 20px; background-color: #008A32;"></i>
    ...
    <div class="modal fade" id="historyModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(0px);">
                <div class="modal-header mx-auto" style="border-radius: 15px; background: transparent; border-bottom: none; border-left: 3px solid #31a531be; border-right: 3px solid #31a531be;">
                ...
                <div class="move">
                    <div class="modal-body bg-dark responsive pt-5" style="border-top: 0.5px inset #31a531be; border-bottom: 1px inset #31a531be;">
    ...
    <div class="modal fade" id="changeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content pt-3" style="background: transparent; backdrop-filter: blur(3px); border-bottom: 2px solid #008A32;">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid #008A32; border-right: 3px solid #008A32; border-bottom: none; border-radius: 15px;">
