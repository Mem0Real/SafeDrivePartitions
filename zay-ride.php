...
<body>
        ...
        <div class="container">
			<nav class="navbar navbar-expand-lg navbar-light w-100">
                <div class="container-fluid">
                    <a class="navbar-brand pt-1" href="#" style="color: white;"><img src="./images/zaylogo.png" width="70px" height="50px"></a>
			    ...
			    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			      <ul class="navbar-nav">
                    ...
                    <div class="nav-item">
                        <div class="dropdown">
                            <i id="viewNewBtn" class="far fa-bell btn rounded-circle dropbtn mb-2" style="font-size: 20px; background-color: lightblue;"></i>
                            <span id="countIcon" class="badge rounded-circle"></span> 
                            
                            <div id="myDropdown" class="dropdown-content mt-3 pull-right mx-auto" onclick="event.stopPropagation()">
                            </div>
                        </div>                       
                    </div>
    ...
    <!-- Zay Ride Area -->
    <div class="slider-area5 bg-image">
		<div class="container">
			<div class="row">
    ...
    <div class="modal fade" id="historyModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background: transparent; backdrop-filter: blur(3px);">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid lightblue; border-right: 3px solid lightblue; border-bottom: none; border-radius: 15px;">
                ...
                <div class="move">
                    <div class="modal-body bg-dark responsive pt-5" style="border-top: 1.5px solid #000; border-bottom: 10px solid #000;">
    ...
    <div class="modal fade" id="changeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content pt-3" style="background: transparent; backdrop-filter: blur(3px); border-bottom: 0.5px solid lightblue;">
                <div class="modal-header mx-auto" style="background: transparent; border-left: 3px solid lightblue; border-right: 3px solid lightblue; border-bottom: none; border-radius: 15px;">
